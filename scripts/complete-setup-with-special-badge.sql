...
CREATE TABLE IF NOT EXISTS profile_themes (
  ...
  background_image TEXT DEFAULT '',
  background_pattern TEXT DEFAULT '',
  custom_css TEXT DEFAULT '',
...
BEGIN
  ...
  -- Award special badge to chersbobers
  IF final_username = 'chersbobers' THEN
    INSERT INTO public.user_badges (user_id, badge_id)
    SELECT NEW.id, id FROM public.badges WHERE name = 'The You Place Creator'
...
-- Insert default badges including special creator badge
...
('The You Place Creator', 'The mastermind behind The You Place', '⭐', '#ff6b35', 0, true)
ON CONFLICT (name) DO NOTHING;

-- Insert default profile themes
INSERT INTO profile_themes (name, description, primary_color, secondary_color, accent_color, background_color, text_color, background_pattern, is_premium) VALUES
('Classic Blue', 'The original You Place look', '#3b82f6', '#64748b', '#f59e0b', '#ffffff', '#1f2937', 'none', false),
('Dark Mode', 'Easy on the eyes, perfect for night browsing', '#6366f1', '#9ca3af', '#fbbf24', '#111827', '#f9fafb', 'dark', false),
('Sunset Vibes', 'Warm oranges and reds like a beautiful sunset', '#f97316', '#ef4444', '#fbbf24', '#fef3c7', '#92400e', 'gradient', false),
('Ocean Breeze', 'Cool blues and teals like the ocean', '#0ea5e9', '#06b6d4', '#10b981', '#e0f2fe', '#0c4a6e', 'waves', false),
('Forest Green', 'Natural greens inspired by nature', '#10b981', '#059669', '#84cc16', '#ecfdf5', '#064e3b', 'leaves', false),
('Purple Dream', 'Mystical purples and pinks', '#8b5cf6', '#a855f7', '#ec4899', '#faf5ff', '#581c87', 'stars', false),
('Retro Pink', 'Nostalgic pink vibes from the old internet', '#ec4899', '#f472b6', '#fbbf24', '#fdf2f8', '#831843', 'retro', true),
('Neon Cyber', 'Futuristic neon colors', '#06b6d4', '#8b5cf6', '#f59e0b', '#0f172a', '#e2e8f0', 'circuit', true),
('Golden Luxury', 'Premium gold and black theme', '#fbbf24', '#f59e0b', '#eab308', '#1f2937', '#f9fafb', 'marble', true)
ON CONFLICT (name) DO NOTHING;
